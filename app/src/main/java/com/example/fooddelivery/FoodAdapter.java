...
public class FoodAdapter extends RecyclerView.Adapter<com.example.fooddelivery.FoodAdapter.FoodHolder> {
    ...
    public void onBindViewHolder(@NonNull FoodHolder holder, int position) {
        holder.price.setText(String.format("%dDh",data.get(position).getPrice()));

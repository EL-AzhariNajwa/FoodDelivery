...
public class FoodCategoryAdapter extends RecyclerView.Adapter<com.example.fooddelivery.FoodCategoryAdapter.CategoryHolder> {
...
//            // Make card selected
//            holder.cardView.setOutlineSpotShadowColor(context.getColor(R.color.colorPrimaryDark));
//            holder.cardView.setOutlineAmbientShadowColor(context.getColor(R.color.colorPrimaryDark));
//            holder.cardView.setStrokeWidth(2);
//            holder.title.setTextColor(context.getColor(R.color.colorPrimaryDark));
//            holder.image.setColorFilter(ContextCompat.getColor(context,R.color.colorPrimaryDark), PorterDuff.Mode.SRC_IN);
//        }else {
//            // Make card inactive

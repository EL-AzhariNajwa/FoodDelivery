    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        switch (position)
        {
            case 0:
                ...
                title.setText("Yummy and fresh food");
                desc.setText("Your order has been placed!You will receive an email receipt shortly");
            ...
            case 1:
                ...
                title.setText("Delivery is given on time");
                desc.setText("Your order has been placed!You will receive an email receipt shortly");
